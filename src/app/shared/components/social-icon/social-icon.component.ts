...
import { SocialLink } from '@core/models/resume.model';

/**
 * Renderiza el icono SVG correspondiente a un enlace social.
 * Los SVG son inline para evitar dependencias externas de iconos.
 */
@Component({
